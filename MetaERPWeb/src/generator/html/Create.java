...
public class Create
{
  ...
  protected final String TEXT_20 = NL + "\t\t" + NL + "\t{BEFORE_SUBMIT_TAG}" + NL + "\t<input type=\"submit\"{SUBMIT_TAG_EXTRA} />" + NL + "\t{AFTER_SUBMIT_TAG}" + NL + "\t" + NL + "</form>" + NL + "{AFTER_FORM_TAG}" + NL + "" + NL + "{AFTER_THIS_CONTENT_PAGE}" + NL + "{AFTER_ALL_CONTENT_PAGES}";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append( createBox.generate(entity).replaceAll("\\{BOX_TITLE\\}", "Standard Data") );
    ...
    stringBuffer.append( createBox.generate(subEntity).replaceAll("\\{BOX_TITLE\\}", StringHelper.name2system(subEntity.getName())) );
    stringBuffer.append(TEXT_15);
     SubEntityN subEntityN = new SubEntityN(subEntity, true, "*"); 
    stringBuffer.append(TEXT_16);
    stringBuffer.append( createBox.generate(subEntityN).replaceAll("\\{BOX_TITLE\\}", StringHelper.name2system(subEntity.getName())) );
