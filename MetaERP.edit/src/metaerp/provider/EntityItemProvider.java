...
/**
 * This is the item provider adapter for a {@link metaerp.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetaerpPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCardinalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_cardinality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_cardinality_feature", "_UI_Entity_type"),
				 MetaerpPackage.Literals.ENTITY__CARDINALITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetaerpPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(MetaerpPackage.Literals.ENTITY__SUB_ENTITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetaerpPackage.Literals.ENTITY__ATTRIBUTES,
				 MetaerpFactory.eINSTANCE.createAttribute()));
		...
		newChildDescriptors.add
			(createChildParameter
				(MetaerpPackage.Literals.ENTITY__SUB_ENTITY,
				 MetaerpFactory.eINSTANCE.createEntity()));

		newChildDescriptors.add
			(createChildParameter
				(MetaerpPackage.Literals.ENTITY__SUB_ENTITY,
				 MetaerpFactory.eINSTANCE.createEntityRelated()));
	}
